...
<link href="${ctx}/resources/css/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
<link href="${ctx}/resources/css/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
<link href="${ctx}/resources/css/pace.min.css" rel="stylesheet" />
<link href="${ctx}/resources/css/lib/bootstrap.min.css" rel="stylesheet">
...
<c:set var="pace" value="${ctx}/resources/js/pace.min.js" />
<c:set var="app" value="${ctx}/resources/js/app.js" />

<script src="${jquery}"></script>
<script src="${bootstrap}"></script>
<script src="${simplebar}"></script>
